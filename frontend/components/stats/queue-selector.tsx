...
export function QueueSelector({
    ...
    // Find selected queue name for display
    ...
    const displayText = selectedQueue
    ...
    return (
        <div ref={containerRef} className={cn("relative w-full", className)}>
            ...
            <Input
                ref={inputRef}
                placeholder={selectedQueue ? displayText : placeholder}
                className={cn(
                    "pl-10 pr-8 h-11 text-base bg-white",
                    selectedQueue && !inputValue && "text-slate-900"
                )}
                value={inputValue}
